...
from app.views import PortfolioView, SignupView, LoginView, HomeView, AccountInfoView, ChildCreateView, QuoteDetailView, CommentDeleteView, QuoteEditView, QuoteDeleteView, ChildListView, ChildEditView, ChildDeleteView, FamilyInviteView, FamilySignupView, PublicQuoteView
...
urlpatterns = [
    ...
    path('user/<int:user_id>/quotes/', PublicQuoteView.as_view(), name='public_quote_list'),
